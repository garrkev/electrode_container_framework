...
SWIFT_CLASS("_TtC18ElectrodeContainer40ElectrodetestMiniappNavigationController")
@interface ElectrodetestMiniappNavigationController : ENBaseNavigationController
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
